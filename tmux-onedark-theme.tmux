...
session_icon=$(get "@onedark_session_icon" "")
session_icon_color=$(get "@onedark_session_icon_color" $onedark_blue)
...
set "status-left" "#[fg=$session_icon_color,bg=$onedark_black] $session_icon #[fg=$onedark_white,bg=$onedark_black]#S "
