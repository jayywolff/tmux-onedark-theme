...
set "status-left" "#[fg=$onedark_blue,bg=$onedark_black]  #[fg=$onedark_white,bg=$onedark_visual_grey]#S#[fg=$onedark_visual_grey,bg=$onedark_visual_grey,nobold,nounderscore,noitalics]"
